...
export const Bar = () => (
  <section id="bar" className="section-shell relative overflow-hidden py-32 md:py-40">
    <div className="absolute inset-0">
      <img src={barDrink} alt="Yàn Yàn signature cocktail" className="h-full w-full object-cover scale-[1.04]" loading="lazy" width={1435} height={2048} />
      <div className="absolute inset-0" style={{ background: "linear-gradient(90deg, hsl(0 90% 4% / 0.97) 0%, hsl(0 85% 8% / 0.78) 42%, hsl(0 85% 5% / 0.5) 100%)" }} />
      <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 82% 50%, hsl(43 70% 40% / 0.18), transparent 58%)" }} />
    </div>

    <div className="container relative grid gap-12 md:grid-cols-2">
      <div className="reveal-left max-w-xl">
        <p className="ornament font-sans-lux mb-8 justify-start text-[10px] text-gold">The Bar</p>
        ...
        <p className="font-serif-lux mb-10 text-xl italic leading-relaxed text-ivory/70 md:text-[1.35rem]">
        ...
        <a href="#reserve" className="btn-gold">Reserve the Lounge</a>
      </div>
    </div>
  </section>
);
