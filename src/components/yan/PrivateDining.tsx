    ...
    <div className="container relative grid items-center gap-16 md:grid-cols-[0.95fr_1.05fr] lg:gap-24">
      ...
      <div className="reveal-left order-2 relative group md:order-1">
        ...
        <div className="relative overflow-hidden gold-border shadow-deep">
          <img
            src={room}
            alt="Yàn Yàn private dining room"
            className="zoom-img h-[540px] w-full object-cover md:h-[620px]"
            loading="lazy"
            width={2048}
            height={1358}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, transparent 60%, hsl(0 90% 4% / 0.55))",
            }}
          />
        </div>
      </div>
      ...
      <div className="reveal-right order-1 md:order-2">
        ...
        <p className="copy-luxe mb-6 text-[1.65rem] text-ivory/90 md:text-[1.95rem]">
          A chandelier-lit private room sets the tone for celebratory dinners,
          tasting menus, business hosting, and intimate gatherings with elevated service.
        </p>

        <p className="copy-luxe mb-10 text-xl italic text-ivory/68 md:text-[1.35rem]">
          Rich textures, warm wood, curated wine presence, and a table arrangement
          designed for conversation and ceremony.
        </p>
